 ...
 * @Last Modified time: 2023-06-29 09:51:18
 * Reproduced with permission, for Swinburne University.
 */
...
$(function() {
    ...
    if (am.site.name == "Unsplash") {
        ...
        key = "MG1uZmVZVk94cjFnLWZ4bDZCczVUNHpOeWhvVVFDM29TdkJZMTR0Y04xWQ==";
        // API call
    ...
    if (am.site.name == "Pexels") {
        ...
        key = "TW1nRFRHdlZmNU9WRU9yd0ZTM0FIcUJSRmNDNkhOQ2ZENXJrcFlpanBqN3NqTW50OVV6Zmczck8=";
    ...
    if (am.site.name == "Flickr CC") {
        ...
        key = "NGJjYWNhMmMzZDJmNDI2NWEyZjUyZDkyZGE4ZWJjMzI=";
    ...
    if (am.site.name == "YouTube") {
        ...
        key = "QUl6YVN5RGJkUGxLc0xqT0tSdTRHLUE3SW1UendJYlR1RmphQXVJ";
        // API call
    ...
    $("button.embed").click(function(event) {
        ...
        // If Youtube, replace image in embed code with dummy image
        if (am.site.name == "YouTube") {
...
<figcaption>
    ...
    // YouTube snippet
    function ytSnippet() {
        let snippet = `<div class="content-box pad-box border border-trbl border-round" style="border-color: #999aa0; border-width: 1px; border-radius: 0.4em;">
    <h3 style="color: black;"><span style="display: inline-block; padding: 8px 16px; border: 4px solid #999aa0; border-radius: 2em;"><strong><span style="font-family: InstructureIcons-Line;" aria-hidden="true"></span> Watch</strong></span> ${am.title} (<span class="timecode">${am.video.timecode}</span>)</h3>
    ...
    <details><summary style = "font-size: 0.8em">Show attribution</summary>
        <small>${am.attribution.username} (${am.video.published}). <em>${am.title}</em> [Video]. YouTube. https://www.youtube.com/watch?v=${am.id}</small></div>
</div></detils>`;
        return snippet;
    }
